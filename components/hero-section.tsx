      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 justify-center items-center">
        <div className="max-w-6xl mx-auto text-center justify-center">
          ...
          <div className="grid grid-cols-2 gap-4 justify-center mx-16">
            <div>
              <FadeIn delay={0.6}>
                <h1 className="text-base sm:text-2xl bold text-white max-w-2xl mx-auto mb-4 rounded-md text-left">
              ...
              <FadeIn delay={0.6}>
                <p className="text-base sm:text-lg text-white bg-black mb-4 max-w-2xl mx-auto p-8 rounded-md text-left">
              ...
              <FadeIn delay={0.6}>
                <div className="text-base sm:text-lg text-white bg-rgba(60, 60, 60, 0.1) rounded-md border border-white mb-4 max-w-2xl mx-auto p-8 rounded-md text-left grid grid-cols-2 gap-4">
                  <div>
                    👋 See me on
                    <br></br>
                    <div className="grid grid-cols-1 gap-2 justify-center pt-3">
                      ...
                      <a href="https://web.facebook.com/pho.hongleap.2025/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 underline">Facebook</a>
                      <a href="https://github.com/hongleap" target="_blank" rel="noopener noreferrer" className="text-slate-400 underline">Github</a>
                    </div>
                  </div>
                  <div>
                    👇 Contact me here
                    <br></br>
                    <div className="grid grid-cols-1 gap-2 justify-center pt-3">
                      <a href="https://t.me/hongleap" target="_blank" rel="noopener noreferrer" className="text-blue-700 underline">Telegram</a>
                    </div>
                  </div>
                </div>  
              </FadeIn>
